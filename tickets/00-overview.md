...
5. **Billing scope** (E10). User directive (2026-08-09): pricing mirrors Instapage — Create €79/mo annual (€99 monthly), Optimize €159/mo annual (€199 monthly), Convert custom — with a 14-day free trial on every plan. Stripe assumed (connector already attached). E10-T01 confirms limits per tier.
