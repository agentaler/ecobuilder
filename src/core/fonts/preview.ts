...
const PREVIEW_LINK_PREFIX = 'ecobuilder-font-preview-'
const PREVIEW_VARIANTS_LINK_PREFIX = 'ecobuilder-font-preview-variants-'
...
export function loadFontPreview(family: string): void {
  ...
  link.setAttribute('data-source', 'ecobuilder-font-preview')
...
export function loadFontPreviewWithVariants(family: string, variants: readonly string[]): void {
  ...
  link.setAttribute('data-source', 'ecobuilder-font-preview-variants')
  document.head.appendChild(link)
}
