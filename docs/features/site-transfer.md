...
- Endpoints:
  ...
  - `POST /admin/api/cms/export/estimate` — exact byte size for an `ExportRequest`, without reading media off disk
...
- [docs/features/media.md](media.md) — imported media falls back to originals when variants are absent
